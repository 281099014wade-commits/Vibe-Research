...
import { NAV, NAV_GROUP_LOOP, navByPath, type NavItem } from "../../lib/nav";
...
function Sidebar() {
  ...
  const loop = NAV.filter((n) => n.group === NAV_GROUP_LOOP);
  ...
  return (
    ...
    >
      <div className="mb-5 flex items-center gap-2 px-1.5">
        ...
        <span className="hidden text-[13px] font-medium tracking-wide lg:inline">经营看板</span>
      </div>
      ...
      <nav className="min-h-0 flex-1 space-y-1 overflow-y-auto">
        ...
        <div className="px-2.5 pb-1 pt-4 text-[10.5px] tracking-widest text-muted-foreground">
          <span className="hidden lg:inline">{NAV_GROUP_LOOP}</span>
